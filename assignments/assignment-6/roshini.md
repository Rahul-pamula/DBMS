# Assignment 6: SQL Constraints & Referential Integrity
...
## Conclusion
SQL constraints (`NOT NULL`, `UNIQUE`, `DEFAULT`, `CHECK`, `PRIMARY KEY`, `FOREIGN KEY`, and Composite Primary Keys) enforce data integrity, validate business rules, and ensure referential consistency across related tables in a database.
